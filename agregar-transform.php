...
?>
		...
		<div class="container">
			<div class="section">
				<h5 class="section-title">Publicar transfor</h5>
				...
				<div class="row">
						...
						<?php
							if(isset($_POST['publish-news'])) {
								$title = $_POST['title'];
								$titleError = '<p class="panel-error">Tienes que insertar un número de transform</p>';
								checkEmptyInput($title, $titleError);
							}
						?>
						<div class="input-field col s12 m12">
							<input type="text" id="title" name="title">
							<label for="title">Número de transform</label>
						</div>
						...
						<?php
							if(isset($_POST['publish-news']) AND !empty($title) AND !empty($author)) {
								...
								$publishNews_Query = "INSERT INTO transform (transform, imagen) VALUES (?, ?)";
