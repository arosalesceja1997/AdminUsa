		...
		<div class="container">
			<div class="section">
				<div style="width: 75%; margin: auto; text-align: center;">
					<?php
						$getSelectedNews_Query = "SELECT * FROM calendario WHERE id = ?";
						...
						$dia = $row->numero_dia;
					?>
					<h3 class="shrink-text-730">¿Estás seguro/a que quieres eliminar este día?</h3>
					<div style="margin: 40px 0;">
					<h5>Día de la semana</h5>
					<h6 style="color: rgba(0, 0, 0, .5)">Día <?php echo $dia; ?></h6>
					...
					<div style="margin: 25px 0;">
						<form action="" method="post" style="display: inline-block;">
							<?php
								...
								$mensajeLogs = "<strong>".$_SESSION['username']."</strong> eliminó un día del calendario";
						...
						<a href="/admin/calendario" class="btn-flat waves-effect waves-red">No</a>
					</div>
					</div>
				</div>
			</div>
