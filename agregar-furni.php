					...
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="col s12">
							<?php
								...
								$mensajeLogs = "<strong>".$_SESSION['username']."</strong> agregó un furni";
								...
								$logs->execute(array($mensajeLogs, $_SESSION['username']));	
									...
									$addMember_Query = "INSERT INTO furnis_nuevos (nombre, descripcion, imagen) VALUES (?, ?, ?)";
									$addMember = $db->prepare($addMember_Query);

									$addMember->execute(array($name, $descripcion, $file_path));
									echo '<script>window.location="/admin/lista-furnis"</script>';
