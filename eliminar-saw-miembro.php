<?php
	...
	if(isset($_GET['id']) AND !empty($_GET['id'])) {
		...
		echo '<script>window.location.href="/admin/saw-miembros";</script>';
	}
		...
		<div class="container">
			<div class="section">
				<div style="width: 75%; margin: auto; text-align: center;">
					<?php
						$getSelectedMember_Query = "SELECT nombre, rango FROM saw_miembros WHERE id = ?";
					...
					<div style="margin: 25px 0;">
						<form action="" method="post" style="display: inline-block;">
							<?php
								if(isset($_POST['delete-member'])) {
									...
									$deleteMember_Query = "DELETE FROM saw_miembros WHERE id = ?";
						...
						<a href="/admin/saw-miembros" class="btn-flat waves-effect waves-red">No</a>
					</div>
					</div>
				</div>
			</div>
