		...
		<div class="container">
			<div class="section">
				<div style="width: 75%; margin: auto; text-align: center;">
					<?php
						$getSelectedNews_Query = "SELECT * FROM furnis_nuevos WHERE id = ?";
						...
						$imagen = $row->imagen; 
					?>
					<h3 class="shrink-text-730">¿Estás seguro/a que quieres eliminar este furni??</h3>
					<div style="margin: 40px 0;">
					<h5>Nombre</h5>
					<h6 style="color: rgba(0, 0, 0, .5)"><?php echo $nombre; ?></h6>
					<h5>Descripción</h5>
					<h6 style="color: rgba(0, 0, 0, .5)"><?php echo $descripcion; ?></h6>
					<h5>Imagen</h5>
					...
					<div style="margin: 25px 0;">
						<form action="" method="post" style="display: inline-block;">
							<?php
								if(isset($_POST['delete-news'])) {
									$mensajeLogs = "<strong>".$_SESSION['username']."</strong> eliminó un furni";
						...
						<a href="/admin/lista-furnis" class="btn-flat waves-effect waves-red">No</a>
					</div>
					</div>
				</div>
			</div>
