		...
		<div class="container">
			<div class="section">
				<div style="width: 75%; margin: auto; text-align: center;">
					<?php
						$getSelectedNews_Query = "SELECT * FROM enables WHERE id = ?";
						...
						$imagen = $row->imagen;
					?>
					<h3 class="shrink-text-730">¿Estás seguro/a que quieres eliminar este enable??</h3>
					<div style="margin: 40px 0;">
					<h5>Número</h5>
					<h6 style="color: rgba(0, 0, 0, .5)"><?php echo $enable; ?></h6>
					<h5>Imagen</h5>
					...
					<div style="margin: 25px 0;">
						<form action="" method="post" style="display: inline-block;">
							<?php
								...
								$mensajeLogs = "<strong>".$_SESSION['username']."</strong> eliminó un comando :enable";
						...
						<a href="/admin/lista-enables" class="btn-flat waves-effect waves-red">No</a>
					</div>
					</div>
				</div>
			</div>
